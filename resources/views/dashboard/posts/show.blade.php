        ...
        <div class="row my-3">
            <div class="col-lg-8">
                ...
                <form action="/dashboard/posts/{{ $post->slug }}" method="POST" class="d-inline">
                    @csrf
                    @method('delete')
                    <button class="btn btn-danger" onclick="return confirm('Are you sure delete this post?')"><i class="bi bi-x-circle"></i> Delete</button>
                </form>
                ...
                @else
                    <img src="https://source.unsplash.com/1200x600?{{ $post->category->name }}" alt="{{ $post->slug }}" class="img-fluid mt-3">
                @endif
